...
guards.describeMcqRules(api, guardDoc, {
    ...
    /* لا مخالفة طول قائمة في هذا الدرس (18 أغسطس 2026).
       e8 أُصلح في 17 أغسطس، والخمس الباقية (meltQ · paradoxQ ·
       breakIonic · etheneConduct · graphiteQ) أُصلحت اليوم
       بإطالة مشتّتاتها لا بتقصير إجاباتها الصحيحة. فحُذفت
       مدخلاتها، ويسري عليها الحدّ العامّ الآن. */
  });
