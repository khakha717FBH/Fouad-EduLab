...
const SUITES = [
  ...
  'geometry-l1.test.js',    // فحص عددي لمسارح درس 01 — راسم الذرّة المحلّي
  ...
  'lesson-u3-01.test.js',   // الوحدة 03 · الدرس 01 — أوّل درس فيزياء
  'geometry-u3-01.test.js'  // فحص عددي لمسرح تكوّن الصورة + حرّاس الاختيار
];
