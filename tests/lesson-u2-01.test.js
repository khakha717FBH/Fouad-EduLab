...
guards.describeMcqRules(api, guardDoc, {
    ...
    /* أربع مخالفات قائمة، كلّها داخل الدرس لا في التقييم —
       الطالب يرى تصحيحها وتفسيرها فورًا، والخطأ نفسه تعليم.
       ولم يكن هذا الحارس مربوطًا بهذا الدرس يوم بُني، فمرّت.
       الأرقام سقوفٌ معلنة لا إعفاء: يسقط الحارس إن ازدادت،
       وتُحذف المدخلة عند إصلاح نصّها. */
    lengthGap:    { known: {
      'u2l1-helmet': 50, 'u2l1-cast': 36,
      'u2l1-support-property': 34, 'u2l1-shape-function-pattern': 67
    } }
  });
